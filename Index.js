...
bot.on('message', async msg => {
    ...
    if(!cmd) return msg.reply(`\`${cmd}\` is not a valid command. If you would like it to be a command then you may dm MatthewLitwiz#4494.`);
...
bot.on('ready', () => {
    ...
    bot.user.setActivity('Matthew Code', { type: "LISTENING"})
})
