...
module.exports = {
    ...
    description: "Warns user",
      async execute(bot, message, args){
          ...
          if (!message.member.hasPermission("MANAGE_MESSAGES")) return message.channel.send("You do not have permission to run that command!"); //Checks to see if the user has permission to warn members.
